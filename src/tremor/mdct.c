...
/* used by the lowmem bitreverse permutation (mdct_bitreverse) below */
...
/* permutation-only bit-reversal; does not fold in a cross-product
   reconstruction step (the master-shaped pipeline's variant that did was
   removed with mdct_backward_full) */
